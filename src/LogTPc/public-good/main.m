%main procedure for LogTP (version for directly extended problems)
%public good provision model
clc
clear
global L N M d0 b0 opt1 Sigma d e lin eta pri p
...
e = lognrnd(0,1,1,N); % random problems: the efforts
d = 0.2; % cost for each link
lin = link(N);
