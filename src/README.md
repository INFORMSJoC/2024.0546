...
Note. LogTP (LogTPc and LogTPm) and ALogTP are the algorithms we developed in the paper. We also implemented DaE and LinTP and distributed them with LogTP.
